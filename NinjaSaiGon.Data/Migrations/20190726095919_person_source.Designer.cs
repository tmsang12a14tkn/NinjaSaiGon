...
namespace NinjaSaiGon.Data.Migrations
{
    ...
    [Migration("20190726095919_person_source")]
    partial class person_source
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NinjaSaiGon.Data.Models.BranchPosition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("NinjaSaiGon.Data.Models.BranchPositionLevel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("BranchPositionLevels");
                });
            ...
            modelBuilder.Entity("NinjaSaiGon.Data.Models.DepartmentPositionLevel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("DepartmentPositionLevels");
                });
            ...
            modelBuilder.Entity("NinjaSaiGon.Data.Models.ManufactoryPosition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("ManufactoryPositions");
                });

            modelBuilder.Entity("NinjaSaiGon.Data.Models.ManufactoryPositionLevel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("ManufactoryPositionLevels");
                });
            ...
            modelBuilder.Entity("NinjaSaiGon.Data.Models.PersonBranch", b =>
                {
                    b.Property<int>("PersonId");
                    ...
                    b.HasKey("PersonId", "BranchId");

                    b.HasIndex("PositionId");

                    b.HasIndex("PersonId", "CompanyId");

                    b.ToTable("PersonBranches");
                });

            modelBuilder.Entity("NinjaSaiGon.Data.Models.PersonCompany", b =>
                {
                    b.Property<int>("PersonId");
                    ...
                    b.Property<string>("TrialWorkBeginDate");

                    b.Property<string>("WorkBeginDate");
            ...
            modelBuilder.Entity("NinjaSaiGon.Data.Models.PersonDepartment", b =>
                {
                    b.Property<int>("PersonId");
                    ...
                    b.HasIndex("PersonId", "ManufactoryId");

                    b.HasIndex("PersonId", "RepresentativeOfficeId");
            ...
            modelBuilder.Entity("NinjaSaiGon.Data.Models.PersonManufactory", b =>
                {
                    b.Property<int>("PersonId");
                    ...
                    b.HasKey("PersonId", "ManufactoryId");
                    ...
                    b.ToTable("PersonManufactories");
                });

            modelBuilder.Entity("NinjaSaiGon.Data.Models.PersonRepresentativeOffice", b =>
                {
                    b.Property<int>("PersonId");
                    ...
                    b.HasKey("PersonId", "RepresentativeOfficeId");

                    b.HasIndex("PositionId");

                    b.HasIndex("PersonId", "CompanyId");

                    b.ToTable("PersonRepresentativeOffices");
                });
            ...
            modelBuilder.Entity("NinjaSaiGon.Data.Models.Position", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("NinjaSaiGon.Data.Models.PositionLevel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("NinjaSaiGon.Data.Models.RepresentativeOfficePosition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("RepresentativeOfficePosition");
                });

            modelBuilder.Entity("NinjaSaiGon.Data.Models.RepresentativeOfficePositionLevel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("RepresentativeOfficePositionLevel");
                });
            ...
            modelBuilder.Entity("NinjaSaiGon.Data.Models.BranchPosition", b =>
                {
                    b.HasOne("NinjaSaiGon.Data.Models.BranchPositionLevel", "Level")
                        .WithMany("Positions")
            ...
            modelBuilder.Entity("NinjaSaiGon.Data.Models.DepartmentPosition", b =>
                {
                    b.HasOne("NinjaSaiGon.Data.Models.DepartmentPositionLevel", "Level")
                        .WithMany("Positions")
                        .HasForeignKey("LevelId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("NinjaSaiGon.Data.Models.ManufactoryPosition", b =>
                {
                    b.HasOne("NinjaSaiGon.Data.Models.ManufactoryPositionLevel", "Level")
                        .WithMany("Positions")
                        .HasForeignKey("LevelId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("NinjaSaiGon.Data.Models.PersonBranch", b =>
                {
                    b.HasOne("NinjaSaiGon.Data.Models.Person", "Person")
                        .WithMany("PersonBranches")
                        .HasForeignKey("PersonId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("NinjaSaiGon.Data.Models.BranchPosition", "Position")
                        .WithMany()
                        .HasForeignKey("PositionId");

                    b.HasOne("NinjaSaiGon.Data.Models.PersonCompany", "PersonCompany")
                        .WithMany("PersonBranches")
                        .HasForeignKey("PersonId", "CompanyId");
                });
            ...
            modelBuilder.Entity("NinjaSaiGon.Data.Models.PersonCompany", b =>
                {
                    ...
                    b.HasOne("NinjaSaiGon.Data.Models.Position", "Position")
                        .WithMany()
                        .HasForeignKey("PositionId");
                });
            ...
            modelBuilder.Entity("NinjaSaiGon.Data.Models.PersonDepartment", b =>
                {
                    ...
                    b.HasOne("NinjaSaiGon.Data.Models.DepartmentPosition", "Position")
                        .WithMany()
                        .HasForeignKey("PositionId");

                    b.HasOne("NinjaSaiGon.Data.Models.PersonBranch", "PersonBranch")
                        .WithMany("PersonDepartments")
                        .HasForeignKey("PersonId", "BranchId");

                    b.HasOne("NinjaSaiGon.Data.Models.PersonCompany", "PersonCompany")
                        .WithMany("PersonDepartments")
                        .HasForeignKey("PersonId", "CompanyId");

                    b.HasOne("NinjaSaiGon.Data.Models.PersonManufactory", "PersonManufactory")
                        .WithMany("PersonDepartments")
                        .HasForeignKey("PersonId", "ManufactoryId");

                    b.HasOne("NinjaSaiGon.Data.Models.PersonRepresentativeOffice", "PersonRepresentativeOffice")
                        .WithMany("PersonDepartments")
                        .HasForeignKey("PersonId", "RepresentativeOfficeId");
                });

            modelBuilder.Entity("NinjaSaiGon.Data.Models.PersonManufactory", b =>
                {
                    b.HasOne("NinjaSaiGon.Data.Models.Person", "Person")
                        .WithMany("PersonManufactories")
                        .HasForeignKey("PersonId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("NinjaSaiGon.Data.Models.ManufactoryPosition", "Position")
                        .WithMany()
                        .HasForeignKey("PositionId");
            ...
            modelBuilder.Entity("NinjaSaiGon.Data.Models.PersonRepresentativeOffice", b =>
                {
                    ...
                    b.HasOne("NinjaSaiGon.Data.Models.RepresentativeOfficePosition", "Position")
                        .WithMany()
                        .HasForeignKey("PositionId");

                    b.HasOne("NinjaSaiGon.Data.Models.PersonCompany", "PersonCompany")
                        .WithMany("PersonRepresentativeOffices")
                        .HasForeignKey("PersonId", "CompanyId");
                });

            modelBuilder.Entity("NinjaSaiGon.Data.Models.Position", b =>
                {
                    b.HasOne("NinjaSaiGon.Data.Models.PositionLevel", "Level")
                        .WithMany("Positions")
                        .HasForeignKey("LevelId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("NinjaSaiGon.Data.Models.RepresentativeOfficePosition", b =>
                {
                    b.HasOne("NinjaSaiGon.Data.Models.RepresentativeOfficePositionLevel", "Level")
                        .WithMany("Positions")
                        .HasForeignKey("LevelId")
                        .OnDelete(DeleteBehavior.Cascade);
                });

var applicationServerPublicKey = 'BPmrsqUGW4144sdmK_r2hVADv23-R7begeyDlFMFjaIDDM21v4PfnCKM_kLe3FTTlorCY2nLYQFLmZJZ6femGEg';
    ...
    navigator.serviceWorker.ready.then(function (reg) {
        ...
        reg.pushManager.subscribe(subscribeParams)
            .then(function (subscription) {
                ...
                $.post("/Devices/Create", { pushEndpoint: subscription.endpoint, pushP256DH: p256dh, pushAuth: auth })
                    .done(function (data) {
